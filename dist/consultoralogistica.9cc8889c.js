...
"use strict";var e=t(require("waait"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector(".menu"),i=["foto1","foto2","foto3","foto4"],a=o.offsetTop;async function r(){const t=document.querySelector(".img-razones");await(0,e.default)(),t.src=require("./img/foto2.jpg"),await(0,e.default)(5e3),t.src=require("./img/foto3.jpg"),await(0,e.default)(5e3),t.src=require("./img/foto1.jpg"),await(0,e.default)(5e3),r()}function s(){window.pageYOffset>=a?o.classList.add("sticky"):o.classList.remove("sticky")}window.addEventListener("scroll",s),r();
},{"waait":"kLNy","./img/foto2.jpg":"OSYV","./img/foto3.jpg":"Iulu","./img/foto1.jpg":"S5xX"}]},{},["Focm"], null)
//# sourceMappingURL=/consultoralogistica.9cc8889c.js.map